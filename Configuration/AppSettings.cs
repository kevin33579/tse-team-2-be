namespace ProductApi.Configuration
{
    ...
    /// <summary>
    /// Konfigurasi untuk pengiriman email melalui SMTP
    /// Digunakan untuk notifikasi, reset password, konfirmasi akun, dll
    /// </summary>
    public class EmailSettings
    {
        /// <summary>
        /// Server SMTP untuk pengiriman email
        /// Contoh: "smtp.gmail.com", "smtp.outlook.com", "mail.domain.com"
        /// </summary>
        public string SmtpServer { get; set; } = string.Empty;
        
        /// <summary>
        /// Port SMTP server
        /// 587 = untuk TLS, 465 = untuk SSL, 25 = untuk non-encrypted
        /// </summary>
        public int SmtpPort { get; set; }
        
        /// <summary>
        /// Aktifkan SSL/TLS untuk keamanan email
        /// true = gunakan enkripsi, false = tanpa enkripsi (tidak disarankan)
        /// </summary>
        public bool EnableSsl { get; set; }
        
        /// <summary>
        /// Email address yang akan muncul sebagai pengirim
        /// Contoh: "noreply@productapi.com"
        /// </summary>
        public string FromEmail { get; set; } = string.Empty;
        
        /// <summary>
        /// Nama yang akan muncul sebagai pengirim email
        /// Contoh: "Product API System" atau "Admin Tim"
        /// </summary>
